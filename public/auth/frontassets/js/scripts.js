(function ($) {
    ...
    function isIE() {
        ...
        var trident = ua.indexOf("Trident/{{url('/')}}"); //IE 11
    ...
    function isIE() {
        ...
        var msie = ua.indexOf("MSIE "); // IE 10 or older
        var trident = ua.indexOf("Trident/{{url('/')}}"); //IE 11
        var edge = ua.indexOf("Edge/{{url('/')}}"); //IE 11
...
imported.src = "inc/switcher/js/switcher.html";
document.head.appendChild(imported);
var styleE = document.createElement("link");
styleE.href = "inc/switcher/css/switcher.html";
