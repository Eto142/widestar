                                        ...
                                        <form  action="{{route('bank.transfer')}}" method="POST">
                                            ...
                                            <div id="content-one">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input id="pin_account_number" type="text" name="account_name" class="form-control" placeholder="Account Name" >
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label>Account Number</label>
                                                    <input id="pin_account_number" type="text" name="account_number" class="form-control" placeholder="Account Number" >
                                                </div>
                                                <div class="form-group mb-3">
