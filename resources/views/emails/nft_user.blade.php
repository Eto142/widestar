				...
				<tbody>
					<tr class="proton-tr">
						<td class="proton-td" colspan="10" style="">
							...
							<center>
								...
								<img src="{{asset('homepage/images/logo-dark.png')}}" alt="Image" />
							</center>
							
                                  <br>
                                        <p>
                                        You have successfully created a new NFT .
                                        </p>
                                        <br>
                                        <p>
                                          Amount: {{$user['amount']}} ETH
                                        </p>
                                        <br>
                                        <p>
                                          Gas Fee: 0 ETH
					...
					<tr class="proton-tr">
						<td class="proton-td" colspan="10" style="">
							...
							<center>
								<span style="color: #706d6b"> © 2023 Astroartvault</span>
							</center>
