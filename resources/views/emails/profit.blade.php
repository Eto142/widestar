                    ...
                    <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                        ...
                        <tr>
                            <td align='center' height='70' style='height:70px;'>
                                <a href='' style='display: block; border-style: none !important; border: 0 !important;'><img width='100' border='0' style='display: block; width: 300px;' src="{{ asset('user/logo.png') }}" alt="Logo" /></a>
                            </td>
                        </tr>
                    </table>
                </td>
                                ...
                                <tr>
                                    <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        ...
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                         ${{$data['balance']}} USD is now available in your USD balance. Log in to check your balance.
                                        </p>
                                        <br>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                        <a href="https://s9tradingnetwork.cloud/login">https://s9tradingnetwork.cloud/login</a>
                                        </p>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                         To login you'll need your email address and the password you created during signup.
                                        </p>
                                        <br/> 
